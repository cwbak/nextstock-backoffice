...
import type { UsCalendarEarning } from "@/data-access/schemas/us-calendar-earning";
import { UsCalendarEarningsPage } from "@/features/calendar-earnings/components/us-calendar-earnings-page";
...
describe("UsCalendarEarningsPage", () => {
  beforeAll(() => {
