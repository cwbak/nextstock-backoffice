...
import { KrxCalendarEarningsEmptyState } from "@/features/calendar-earnings/components/krx-calendar-earnings-empty-state";
...
export function KrxCalendarEarningsPage() {
  const earningsQuery = useSuspenseQuery(krxCalendarEarningsQueryOptions);
  const {
    state: tableState,
    updatePage,
    updateQuery,
