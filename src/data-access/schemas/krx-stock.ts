...
export const krxStockCodeSchema = z
  .string()
...
export const krxStockSchema = z
  .object({
    code: krxStockCodeSchema,
...
export const krxStockListSchema = z.array(krxStockSchema);

export const krxStockFormSchema = z
  .object({
    code: krxStockCodeSchema,
    corporationCode: corporationCodeSchema,
...
export const krxStockCreatePayloadSchema = z
  .object({
    corporationCode: corporationCodeSchema,
...
export const krxStockUpdatePayloadSchema = krxStockFormSchema.omit({
  code: true,
});

export type KrxStock = z.infer<typeof krxStockSchema>;
export type KrxStockFormValues = z.infer<typeof krxStockFormSchema>;
export type KrxStockCreatePayload = z.infer<typeof krxStockCreatePayloadSchema>;
export type KrxStockUpdatePayload = z.infer<typeof krxStockUpdatePayloadSchema>;
